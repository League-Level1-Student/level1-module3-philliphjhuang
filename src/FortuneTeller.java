...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "Welcome eson");
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			// (freesound.org)dsaasddsaasddddasdfffdasasdffdsaadsffdsaasddffdsaasdffdsa
			AudioClip sound = JApplet.newAudioClip(getClass().getResource("demacia.wav"));
			// 10. Play the sound
			sound.play();
			...
			if (y == 0) {
				...
				JOptionPane.showMessageDialog(null, "Deep Dark Fantasies");
			}
		}
	}
